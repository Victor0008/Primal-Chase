...
TITLE = "Primal Chase 1"
WIDTH = 400
HEIGHT = 300

music1 = pygame.mixer.Sound("suspensao.mp3")
...
crocodile = Actor("crocodile", (400, 270))
crocodile_speed = 6
...
def on_key_down(key):
    if key == keys.SPACE:
        crocodile.x = WIDTH + 100  # Defina a posição do crocodilo fora da tela
